...
## Project Structure
    ...
    ├── peter_simple_delive_40742  # Django project configurations
...
1. Clone this repo and `cd peter_simple_delive_40742`
...
2. Clone this repo and `cd peter_simple_delive_40742`
